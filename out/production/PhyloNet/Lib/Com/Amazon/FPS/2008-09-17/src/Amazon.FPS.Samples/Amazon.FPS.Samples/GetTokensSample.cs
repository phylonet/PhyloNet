...
namespace Amazon.FPS.Samples
{
    ...
    public class GetTokensSample
    {
        ...
        /// <param name="request">GetTokensRequest request</param>
        public static void InvokeGetTokens(AmazonFPS service, GetTokensRequest request)
        {
            try 
            {
                ...
                Console.WriteLine("        GetTokensResponse");
                if (response.IsSetGetTokensResult())
                {
                    Console.WriteLine("            GetTokensResult");
                    GetTokensResult  getTokensResult = response.GetTokensResult;
                    List<Token> tokenList = getTokensResult.Token;
