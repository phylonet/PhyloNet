...
namespace Amazon.FPS
{
    ...
    public class AmazonFPSException : Exception 
    {
        ...
        public AmazonFPSException(String message, HttpStatusCode statusCode) : this (message)
        {
        ...
        public AmazonFPSException(Exception t) : this (t.Message, t) {
        ...
        /// <param name="message">Overview of error</param>
        /// <param name="t">Wrapped exception</param>
        public AmazonFPSException(String message, Exception t) : base (message, t) {
            this.message = message;
            if (t is AmazonFPSException)
            {
        ...
        public AmazonFPSException(String message, HttpStatusCode statusCode, String errorCode, String errorType, String requestId, String xml) : this (message, statusCode)
        {
