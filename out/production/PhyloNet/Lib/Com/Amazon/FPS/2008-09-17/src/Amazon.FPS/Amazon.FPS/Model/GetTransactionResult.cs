...
namespace Amazon.FPS.Model
{
    ...
    public class GetTransactionResult
    {
        ...
        public GetTransactionResult WithTransaction(TransactionDetail transaction)
        {
            this.transactionField = transaction;
            return this;
        }
        ...
        {
            return this.transactionField != null;
        }
        ...
        protected internal String ToXMLFragment() {
            ...
            if (IsSetTransaction()) {
                TransactionDetail  transaction = this.Transaction;
