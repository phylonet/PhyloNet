...
namespace Amazon.FPS.Model
{
    ...
    public class RelatedTransaction
    {
        ...
        public RelatedTransaction WithTransactionId(String transactionId)
        {
        ...
        /// <summary>
        /// Gets and sets the RelationType property.
        /// </summary>
        [XmlElementAttribute(ElementName = "RelationType")]
        public RelationType RelationType
        {
            get { return this.relationTypeField.GetValueOrDefault() ; }
        ...
        /// <summary>
        /// Sets the RelationType property
        /// </summary>
        /// <param name="relationType">RelationType property</param>
        /// <returns>this instance</returns>
        public RelatedTransaction WithRelationType(RelationType relationType)
        {
            this.relationTypeField = relationType;
            return this;
        }
        ...
        /// <summary>
        /// Checks if RelationType property is set
        /// </summary>
        /// <returns>true if RelationType property is set</returns>
        public Boolean IsSetRelationType()
        {
            return this.relationTypeField.HasValue;
