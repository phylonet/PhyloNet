...
<!-- generated with COPASI 4.6 (Build 32) (http://www.copasi.org) at 2011-07-29 23:26:40 UTC -->
...
<COPASI xmlns="http://www.copasi.org/static/schema" versionMajor="1" versionMinor="0" versionDevel="32">
  ...
  <Model key="Model_0" name="New Model" simulationType="time" timeUnit="s" volumeUnit="µl" areaUnit="m²" lengthUnit="m" quantityUnit="nmol" type="deterministic">
    <Comment>
    ...
    <ListOfReactions>
      <Reaction key="Reaction_0" name="hexokinase" reversible="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_1165" name="v" value="0.5"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_1" name="hexokinase-backwards" reversible="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_1164" name="k1" value="1"/>
        </ListOfConstants>
    ...
    <InitialState type="initialState">
      0 0 0 2.25 3.011070750000001e+016 3.011070750000001e+016 5 
    </InitialState>
  </Model>
  <ListOfTasks>
