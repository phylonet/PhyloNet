// Begin CVS Header 
//   $Source: /fs/turing/cvs/copasi_dev/copasi/bindings/java/examples/example8.java,v $ 
//   $Revision: 1.1.2.2 $ 
//   $Name: Build-31 $ 
//   $Author: gauges $ 
//   $Date: 2010/07/25 15:37:10 $ 
// End CVS Header 
...
public class example8
{
  ...
  public static void main(String[] args)
  {
    ...
    if (model != null)
    {
        ...
        long[] userOrder = stateTemplate.getUserOrder();
        ...
        {
            entity = stateTemplate.getEntity(userOrder[i]);
            assert(entity != null);
