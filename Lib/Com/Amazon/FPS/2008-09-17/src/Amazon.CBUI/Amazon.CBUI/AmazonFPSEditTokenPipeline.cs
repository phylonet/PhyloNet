...
namespace Amazon.CBUI
{
        ...
        public class AmazonFPSEditTokenPipeline : AmazonFPSCBUIPipeline
        {
            /**
             * Default constructor
             * 
             ...
             */
            public AmazonFPSEditTokenPipeline(String awsAccessKey, String awsSecretKey):
                base("EditToken", awsAccessKey, awsSecretKey)
            {
            }
            ...
            protected override void validateParameters(IDictionary<String, String> map)
            {
                ...
                {
                    throw new AmazonCBUIException("tokenId is missing in parameters.");
                }
            }
        }
}